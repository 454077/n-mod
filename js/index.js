  ...
  generatePauseRight() {
    ...
    for (let i = 0, len = tech.tech.length; i < len; i++) {
      if (tech.tech[i].count > 0) {
        const style = (localSettings.isHideImages || tech.tech[i].isLore) ? `style="height:auto;"` : (tech.tech[i].isWIP ? `style = 'background-image: url("img/WIP.webp")'` : (tech.tech[i].isJunk) ? `style = 'background-image: url("img/junk.webp"), url("img/${tech.tech[i].name}.webp")'` : `style = 'background-image: url("img/${tech.tech[i].name}.webp"), url("img/junk.webp")'`)
...
<div class="experiment-start-box">
    ...
    for (let i = 0, len = tech.tech.length; i < len; i++) {
      if (localSettings.isJunkExperiment && !tech.tech[i].isLore) {
        const style = localSettings.isHideImages ? hideStyle : (tech.tech[i].isWIP ? `style = 'background-image: url("img/WIP.webp")'` : (tech.tech[i].isJunk) ? `style = 'background-image: url("img/junk.webp"), url("img/${tech.tech[i].name}.webp")'` : `style = "background-image: url('img/${tech.tech[i].name}.webp'), url('img/junk.webp')"`)
